...
# | LOOP_TIME_INTERVAL: the time-interval to sleep
# +--------------------------
# NETWORK = {
#     "FILE_PATH": "network_config/network.p",
#     "LOAD_DATA_FILE_LIST": [
...
# This is not currently used. May need this to support control.
NETWORK_TMP_PATH="./network_ssd.p"
