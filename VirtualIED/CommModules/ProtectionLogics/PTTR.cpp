	            ...
	            do
	            {
	                ...
	                {	
	                    ...
	                    else
	                    {
	                        ...
	                        do
	                        {
	                            cout << "PTTR: " << phy_column_name << " is " << row[0] << endl;
	                            
	                            if(atof(row[0]) > *limit_val)
	                            {
	                                cout << phy_column_name << "'s temperature is higher than the limit value of " << *limit_val << endl;
